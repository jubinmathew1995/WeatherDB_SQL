...
(function () {
	...
	function Aa(a, c, b) {
		if (a && c && b) {
			...
			if ("undefined" !== typeof Blob && new Blob) {
				for (var h = a.replace(/^data:[a-z/]*;base64,/, ""), h = atob(h), k = new ArrayBuffer(h.length), k = new Uint8Array(k), l = 0; l < h.length; l++)
					k[l] = h.charCodeAt(l);
				c = new Blob([k.buffer], {
						type : "image/" + c
					});
				try {
					...
					g.dataset.downloadurl = [d, g.download, g.href].join(":"),
					g.href = window.URL.createObjectURL(c)
				}
			}
			if (!f)
				try {
	...
	function A(a, c, b, d, f) {
		...
		if (this.options.stripLines && 0 < this.options.stripLines.length)
			for (this.stripLines = [], c = 0; c < this.options.stripLines.length; c++)
				this.stripLines.push(new na(this.chart, this.options.stripLines[c], a.theme, ++this.chart._eventManager.lastObjectId, this));
		...
		for (z = r = k = e = l = 0; 0 < m.length; )
			if (c = m.pop(), "#" === c || "0" === c)
				if (l++, l === n) {
					...
					h = [];
					if ("0" === c)
						for (c = n - e - (v ? v.length : 0); 0 < c; )
							v.unshift("0"), c--;
					for (; 0 < v.length; )
						b = v.pop() + b, z++, 0 === z % r && (k === q && 0 < v.length) && (b = g + b);
					d && (b = "-" + b)
				} else
					0 < h.length ? (b = h.pop() + b, e++, z++) : "0" === c && (b = "0" + b, e++, z++), 0 === z % r && (k === q && 0 < h.length) && (b = g + b);
			else
				"E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ? "," === c ? (k++, r = z, z = 0, 0 < h.length && (b = g + b)) : b = 1 < c.length &&
					('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? c.slice(1, c.length - 1) + b : c + b : (c = 0 > s ? c.replace("+", "").replace("-", "") : c.replace("-", ""), b += c.replace(/[0]+/, function (a) {
							return O(s, a.length)
						}));
		d = "";
		for (g = !1; 0 < p.length; )
			c = p.shift(), "#" === c || "0" === c ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(), g = !0) : "0" === c && (d += "0", g = !0) : 1 < c.length && ('"' === c[0] && '"' === c[c.length - 1] || "'" === c[0] && "'" === c[c.length - 1]) ? d += c.slice(1, c.length - 1) : "E" !== c[0] && "e" !== c[0] || "0" !== c[c.length - 1] || !/[eE][+-]*[0]+/.test(c) ?
	...
	K.prototype.setOptions = function (a, c) {
		if (ca[this._defaultsKey]) {
			...
			d;
			for (d in b)
				"publicProperties" !== d && b.hasOwnProperty(d) && (this[d] = a && d in a ? a[d] : c && d in c ? c[d] : b[d])
		}
	};
	K.prototype.get = function (a) {
		...
		if (c.hasOwnProperty(a) || c.publicProperties && c.publicProperties.hasOwnProperty(a))
			return this[a];
	...
	K.prototype.set = function (a, c, b) {
		...
		if ("options" === a)
			this.createUserOptions(c);
		else if (d.hasOwnProperty(a) || d.publicProperties && d.publicProperties.hasOwnProperty(a) && "readWrite" === d.publicProperties[a])
			this.options._isPlaceholder && this.createUserOptions(), this.options[a] = c;
		else {
	...
	K.prototype.createUserOptions = function (a) {
		if ("undefined" !== typeof a || this.options._isPlaceholder)
			if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
				...
				this.options = "undefined" === typeof a ? {}
		 : a,
		a = this.parent.options,
		this.optionsName ? c = this.optionsName : (c = this._defaultsKey) && 0 !== c.length ? (b = c.charAt(0).toLowerCase(), 1 < c.length && (b = b.concat(c.slice(1))), c = b) : c = void 0,
		a[c] = this.options
	};
	...
	K.prototype.dispatchEvent = function (a, c, b) {
		if (a && this._eventListeners[a]) {
			...
			for (var d = this._eventListeners[a],
				f = 0; f < d.length; f++)
				d[f].eventHandler.call(d[f].context, c)
		}
	...
	y.prototype.render = function (a) {
					...
					if (this.options.axisY && 0 < this.options.axisY.length) {
						if (!this.axisY.length)
							for (var b = 0; b < this.options.axisY.length; b++)
								"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[b] = new A(this, this.options.axisY[b], "axisY", "left", b)) : "xySwapped" ===
						...
						this.axisY.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new A(this, this.options.axisY,
					...
					if (this.options.axisY2 && 0 < this.options.axisY2.length) {
						if (!this.axisY2.length)
							for (b = 0; b < this.options.axisY2.length; b++)
								"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new A(this, this.options.axisY2[b], "axisY", "right", b)) :
						...
						this.axisY2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] = new A(this,
					...
					if (this.options.axisX && 0 < this.options.axisX.length) {
						if (!this.axisX.length)
							for (b = 0; b < this.options.axisX.length; b++)
								"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] = new A(this, this.options.axisX[b],
						...
						this.axisX.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[0] =
					...
					if (this.options.axisX2 && 0 < this.options.axisX2.length) {
						if (!this.axisX2.length)
							for (b = 0; b < this.options.axisX2.length; b++)
								"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] = new A(this, this.options.axisX2[b],
		...
		if (this.options.subtitles)
			for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++)
				b = new va(this, this.options.subtitles[a]), this.subtitles.push(b), b.dockInsidePlotArea ? c.push(b) : b.render();
		...
		if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)
			A.setLayoutAndRender(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace());
		...
		0 < d.length ? (l.disableToolTip = !0, l._animator.animate(200, l.animationDuration, function (a) {
				...
				for (var b = 0; b < d.length; b++)
					k = d[b], 1 > a && "undefined" !== typeof k.startTimePercent ? a >= k.startTimePercent && k.animationCallback(k.easingFunction(a -
				...
				for (var a = 0; a < l.plotInfo.plotTypes.length; a++)
					for (var b = l.plotInfo.plotTypes[a], c = 0; c < b.plotUnits.length; c++)
	...
	y.prototype.categoriseDataSeries = function () {
		...
		for (c = 0; c < this.plotInfo.plotTypes.length; c++)
			for (b = this.plotInfo.plotTypes[c], h = a = 0; h < b.plotUnits.length; h++)
		...
		if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
			for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
				...
				if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
					var e = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ?
				...
				for (l = 0; l < k.dataPoints.length; l++) {
					...
					if (0 < l) {
						if (a.axisX.logarithmic) {
							...
							r = d - k.dataPoints[l - 1].x, 0 > r && (r *= -1), b.minDiff > r && 0 !== r && (b.minDiff = r);
		...
		if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
			for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, h = [], k = [], l = Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
				...
				if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
					var s = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ?
				...
				for (n = 0; n < p.dataPoints.length; n++) {
					...
					if (0 < n) {
						if (a.axisX.logarithmic) {
							...
							v = d - p.dataPoints[n - 1].x, 0 > v && (v *= -1), b.minDiff > v && 0 !== v && (b.minDiff = v);
			...
			for (n in h)
				h.hasOwnProperty(n) && !isNaN(n) && (a = h[n], a < c.min && (c.min = Math.min(a, l)), a > c.max && (c.max = a), n < b.viewPortMin || n > b.viewPortMax || (a < c.viewPortMin && (c.viewPortMin = Math.min(a, l)), a > c.viewPortMax && (c.viewPortMax = a)));
			for (n in k)
				k.hasOwnProperty(n) && !isNaN(n) && (a = k[n], a < c.min && (c.min = Math.min(a, l)), a > c.max && (c.max = a), n < b.viewPortMin || n > b.viewPortMax || (a < c.viewPortMin &&
	...
	y.prototype._processStacked100PlotUnit = function (a) {
		if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
			for (var c = a.axisY.dataInfo, b = a.axisX.dataInfo, d, f, g = !1, h = !1, k = !1, l = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
				...
				r;
				if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
					var s = this.sessionVariables.axisX.newViewportMinimum ? this.sessionVariables.axisX.newViewportMinimum :
	...
	y.prototype.getObjectAtXY = function (a, c, b) {
		...
		if (b = this.getDataPointAtXY(a, c, b || !1))
			...
			d = Ka(a, c, this._eventManager.ghostCtx);
		else
			...
			if (!(b && 1 < b.length)) {
				...
				if (this._lastTouchData.scroll && this.zoomEnabled)
					...
					for (b = 0; b < c.length; b++)
						f = c[b], g = document.createEvent("MouseEvent"), g.initMouseEvent(f, !0, !0, window, 1, d.screenX,
					...
					for (var g = 0; g < this._events.length; g++)
						if (this._events[g].hasOwnProperty(b))
							if (d = this._events[g], f = d.bounds, c.x >= f.x1 && c.x <= f.x2 && c.y >= f.y1 && c.y <= f.y2) {
								...
								"mousedown" === b && !0 === d.capture ? (y.capturedEventParam = d, this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler,
										!1)) : "mouseup" === b && (d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", this._mouseEventHandler, !1));
								break
							} else
								d = null;
	...
	y.prototype._plotAreaMouseMove = function (a, c) {
		if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
			...
			h._panTimerId = setTimeout(function (b, d, e, f) {
					return function () {
			...
			this.toolTip.mouseMoveHandler(a, c)
	};
	y.prototype._zoomPanToSelectedRegion = function (a, c, b, d, f) {
		...
		if (a.isValid)
			for (d = 0; d < c.length; d++)
				f = b[d], c[d].setViewPortRange(f.val1, f.val2);
		return a.isValid
	};
	y.prototype.validateRegion = function (a, c, b, d, f) {
		f = f || !1;
		for (var g = 0 <= this.zoomType.indexOf("x"), h = 0 <= this.zoomType.indexOf("y"), k = !1, l = [], m = [], p = [], n = 0; n < this.axisX.length; n++)
			this.axisX[n] &&
			g && m.push(this.axisX[n]);
		for (n = 0; n < this.axisX2.length; n++)
			this.axisX2[n] && g && m.push(this.axisX2[n]);
		for (n = 0; n < this.axisY.length; n++)
			this.axisY[n] && h && m.push(this.axisY[n]);
		for (n = 0; n < this.axisY2.length; n++)
			this.axisY2[n] && h && m.push(this.axisY2[n]);
	...
	y.prototype.renderIndexLabels = function (a) {
		...
		for (var c = this.plotArea, b = 0, d = 0, f = 0, g = 0, h = b = g = d = f = 0, k = 0, l = 0; l < this._indexLabels.length; l++) {
			...
			n,
			e,
			q = Q("indexLabelFontColor", m.dataPoint, m.dataSeries),
			...
			if (null !== w && "" !== w) {
				...
				if (0 <= p.indexOf("line") || 0 <= p.indexOf("area") ||
					...
					if (m.dataPoint.x < $.viewportMinimum || m.dataPoint.x > $.viewportMaximum || m.dataPoint.y < B.viewportMinimum || m.dataPoint.y > B.viewportMaximum)
						continue
				} else if (0 <= p.indexOf("column")) {
					if (m.dataPoint.x < $.viewportMinimum || m.dataPoint.x > $.viewportMaximum || m.bounds.y1 > c.y2 || m.bounds.y2 < c.y1)
						continue
				} else if (0 <= p.indexOf("bar")) {
					if (m.dataPoint.x < $.viewportMinimum || m.dataPoint.x > $.viewportMaximum || m.bounds.x1 > c.x2 || m.bounds.x2 < c.x1)
						continue
				...
				if (0 < k.length) {
					for (var v = !1, r = 0; r < k.length; r++)
						if (s = k[r].x.getTime ? k[r].x.getTime() : k[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !v)))
							if ("number" !== typeof k[r].y)
								0 < r && !(h.connectNullData || v || q) && (c.stroke(), u && b.stroke()), v = !0;
							else {
					...
					for (z = !1, r = 0; r < l.length; r++)
						if (s = l[r].getTime ? l[r].x.getTime() : l[r].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))
							if ("number" !== typeof l[r].y)
								0 < r && !z && (k.connectNullData ? b.setLineDash && (0 < v.length && (k.options.nullDataLineDashType || !l[r - 1].lineDashType)) && (v[v.length - 1].newLineDashArray = p, m = k.nullDataLineDashType) : (c(v), v = [])), z = !0;
							else {
								s = a.axisX.convertValueToPixel(s);
					...
					for (k = 0; k < r.length; k++)
						if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
							...
							if (a.axisY.logarithmic)
								h[b] = r[k].y + (h[b] ? h[b] : 0), 0 < h[b] && (l = a.axisY.convertValueToPixel(h[b]), t = f[b] ? f[b] : m, f[b] = l);
					...
					for (var s = 5 < n && q.bevelEnabled ? !0 : !1, k = 0; k < r.length; k++)
						if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
							...
							if (a.axisY.logarithmic) {
								...
								w = g[b] ? g[b] : 0, t = l + w, l = m + w, g[b] = w + (t - l);
							b = r[k].color ? r[k].color : q._colorSet[k % q._colorSet.length];
							L(c, z, l, v, t, b, 0, null, s && 0 <= r[k].y, 0 > r[k].y && s, !1, !1, q.fillOpacity);
							b = q.dataPointIds[k];
							this._eventManager.objectMap[b] = {
				...
				if (0 < r.length) {
					...
					for (k = 0; k < r.length; k++)
						if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
							...
							t;
							if (a.axisY.logarithmic)
								h[b] = r[k].y + (h[b] ? h[b] : 0), 0 < h[b] && (t = f[b] ? f[b] : m, f[b] = l = a.axisY.convertValueToPixel(h[b]));
							else if (l = a.axisY.convertValueToPixel(r[k].y), 0 <= r[k].y) {
								var w = f[b] ? f[b] : 0;
								t = m + w;
								l += w;
					...
					for (k = 0; k < r.length; k++)
						if (b = r[k].x.getTime ? r[k].x.getTime() : r[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[k].y) {
							...
							if (a.axisY.logarithmic) {
								...
								w = g[b] ? g[b] : 0, z = l - w, l = m - w, g[b] = w + (l - z);
							b = r[k].color ? r[k].color : q._colorSet[k % q._colorSet.length];
			...
			if (0 < c.length) {
				if (0 < m.lineThickness) {
					...
					for (var e = 0; e < c.length - 3; e += 3)
						if (b.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y), u && d.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y), c[e + 3].newStrokeStyle || c[e + 3].newLineDashArray)
							b.stroke(),
				...
				for (e = 0; e < c.length - 3; e += 3)
					b.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y), u && d.bezierCurveTo(c[e + 1].x, c[e + 1].y, c[e + 2].x, c[e + 2].y, c[e + 3].x, c[e + 3].y);
				...
				if (0 < p.length) {
					...
					for (q = !1; n < p.length; n++)
						if (e = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(e < a.axisX.dataInfo.viewPortMin || e > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q)))
							if ("number" !== typeof p[n].y)
								0 < n && !q && (m.connectNullData ? b.setLineDash && (0 < v.length && (m.options.nullDataLineDashType || !p[n - 1].lineDashType)) && (v[v.length -
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var z = [], g =
				...
				for (p = 0; p < w.length; p++)
					v = w[p].x.getTime ? w[p].x.getTime() : w[p].x, t.dataPointIndexes[v] = p, z[v] || (l.push(v), z[v] = !0);
				l.sort(ya)
			}
						...
						if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !N)))
							if ("number" !== typeof H.y)
								...
								if (a.axisY.logarithmic) {
									...
									e = a.axisY.convertValueToPixel(H.y), e -= ea;
								k.push({
									x : n,
									y : r - ea
								});
						...
						if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !N)))
							if ("number" !== typeof H.y)
								...
								if (a.axisY.logarithmic) {
									...
									e = a.axisY.convertValueToPixel(ea), e -= fa;
								k.push({
									x : n,
									y : r - fa
								});
	...
	y.prototype.renderBubble = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var h = -Infinity, k = Infinity, l = 0; l < a.dataSeriesIndexes.length; l++)
				for (var m = a.dataSeriesIndexes[l], p = this.data[m], n = p.dataPoints, e = 0, d = 0; d < n.length; d++)
					f = n[d].getTime ? f = n[d].x.getTime() : f = n[d].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof n[d].z || (e = n[d].z, e >
						h && (h = e), e < k && (k = e));
	...
	y.prototype.renderRangeColumn = function (a) {
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			g,
			h,
			f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth :
				1;
				...
				if (0 < n.length)
					for (var e = 5 < k && p.bevelEnabled ? !0 : !1, f = 0; f <
						...
						if (n[f].getTime ? h = n[f].x.getTime() : h = n[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== n[f].y && n[f].y.length && "number" === typeof n[f].y[0] && "number" === typeof n[f].y[1]) {
							...
							if (n[f].indexLabel || p.indexLabel || n[f].indexLabelFormatter || p.indexLabelFormatter)
								this._indexLabels.push({
				...
				if (0 < e.length) {
					...
					for (f = 0; f < e.length; f++)
						if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) &&
							...
							if (e[f].indexLabel || n.indexLabel || e[f].indexLabelFormatter || n.indexLabelFormatter)
								this._indexLabels.push({
									chartType : "rangeBar",
									dataPoint : e[f],
									dataSeries : n,
		...
		function c() {
			if (z) {
				...
				for (var c = h.length - 1; 0 <= c; c--)
					a = h[c], b.lineTo(a.x, a.y), d.lineTo(a.x, a.y);
				b.closePath();
					...
					for (var A = !0; n < m.length; n++)
						if (s = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !A)))
							if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
								...
								if (m[n].indexLabel || l.indexLabel || m[n].indexLabelFormatter || l.indexLabelFormatter)
									this._indexLabels.push({
										chartType : "rangeArea",
										dataPoint : m[n],
										dataSeries : l,
				...
				if (0 < k.lineThickness) {
					...
					for (var g = f = 0; f < e.length - 3; f += 3, g++) {
						if (q[g].newStrokeStyle || q[g].newLineDashArray)
							b.stroke(), b.beginPath(), b.moveTo(e[f].x, e[f].y), q[g].newStrokeStyle && (b.strokeStyle = q[g].newStrokeStyle), q[g].newLineDashArray && b.setLineDash(q[g].newLineDashArray);
						b.bezierCurveTo(e[f + 1].x, e[f + 1].y, e[f + 2].x, e[f + 2].y, e[f + 3].x, e[f + 3].y)
					}
					b.stroke()
				}
					...
					for (n = !1; m < l.length; m++)
						if (p = l[m].x.getTime ? l[m].x.getTime() : l[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
							if (null !== l[m].y && l[m].y.length && "number" === typeof l[m].y[0] && "number" === typeof l[m].y[1]) {
								...
								0 < m && !n && (k.connectNullData ? b.setLineDash && (0 < q.length && (k.options.nullDataLineDashType || !l[m - 1].lineDashType)) && (q[q.length - 1].newLineDashArray = x, t = k.nullDataLineDashType) :
									(c(w, z), q = [], r = [])), n = !0;
					c(w, z);
					M.drawMarkers(f)
				}
	...
	y.prototype.renderPie = function (a) {
		function c() {
			if (m && p) {
				...
				for (f = 0; f < p.length; f++)
					h = q[(c + f) % p.length], 1 < a && (h.midAngle > Math.PI / 2 - v && h.midAngle < Math.PI / 2 + v) && (g <= a / 2 && !n ? (h.hemisphere = "right", g++) : (h.hemisphere = "left", n = !0));
				n = !1;
				for (f = 0; f < p.length; f++)
					h = q[(d + f) % p.length], 1 < b && (h.midAngle > 3 * Math.PI / 2 - v && h.midAngle < 3 * Math.PI / 2 + v) && (k <= b / 2 && !n ? (h.hemisphere = "left", k++) : (h.hemisphere = "right", n = !0))
			}
		}
		function b(a) {
			...
			for (b = 0; b < p.length; b++) {
				...
				if (d > c) {
					...
					h = !1;
					if (p[b].exploded) {
						if (1E-9 < Math.abs(q[b].center.x - (w.x + f)) || 1E-9 < Math.abs(q[b].center.y - (w.y + g)))
							q[b].center.x = w.x + f * a, q[b].center.y = w.y + g * a, h = !0
					} else if (0 < Math.abs(q[b].center.x - w.x) || 0 < Math.abs(q[b].center.y - w.y))
						q[b].center.x = w.x + f * (1 - a), q[b].center.y = w.y + g * (1 - a),
						h = !0;
			...
			for (b = b = 0; b < p.length; b++)
				c = q[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !==
		...
		function g(a, b, c) {
			...
			if (0 <= a && a < p.length) {
				var l = q[a];
				if (0 > b && l.indexLabelTextBlock.y < h || 0 < b && l.indexLabelTextBlock.y > k)
					return 0;
				var m = 0,
				n = 0,
				n = m = m = 0;
				...
				for (k = 1; k < p.length; k++)
					if (h = (a - k + q.length) % q.length, q[h].hemisphere !== q[a].hemisphere) {
						...
						q[a].hemisphere && h !== a && (0 > d(q[h], q[a]) || ("right" === q[a].hemisphere ? q[h].indexLabelTextBlock.y <= q[a].indexLabelTextBlock.y : q[h].indexLabelTextBlock.y >= q[a].indexLabelTextBlock.y)))
						break;
					else
						h = null;
				n = h;
		...
		function h() {
			...
			for (var b = a = 0, c = 0, h = !0, b = 0; 10 > b && (1 > b || 0 < c); b++) {
				if (m.radius || !m.radius && "undefined" !== typeof m.innerRadius && null !== m.innerRadius && B - c <= A)
					h = !1;
				h && (B -= c);
				c = 0;
				if ("inside" !== m.indexLabelPlacement) {
					...
					for (var v, u, a = 0; a < p.length; a++) {
						...
						if (null !== x) {
							...
							y = d(v, u) - r;
							if (0 > y) {
								for (var D = u = 0, E = 0; E < p.length; E++)
									E !== a && q[E].hemisphere === k.hemisphere && (q[E].indexLabelTextBlock.y < k.indexLabelTextBlock.y ? u++ : D++);
								u = y / (u + D || 1) * D;
								var D = -1 * (y - u),
								C = E = 0;
					...
					for (a = 0; a < p.length; a++)
						k = q[a], s = "pie" === m.type ? 0.7 * B : 0.8 * B, x = w.x + s * Math.cos(k.midAngle), u = w.y + s * Math.sin(k.midAngle), k.indexLabelTextBlock.x = x, k.indexLabelTextBlock.y = u;
				for (a = 0; a < p.length; a++)
					if (k = q[a], x = k.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width)
						x = x = 0, "right" === k.hemisphere ? (x = e.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width +
		...
		if (!(0 >= a.dataSeriesIndexes.length)) {
			...
			for (var y = 0; y < p.length; y++)
				u += Math.abs(p[y].y), !a && ("undefined" !== typeof p[y].indexLabel && null !== p[y].indexLabel && 0 < p[y].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof p[y].label && null !== p[y].label && 0 < p[y].label.toString().length) && (a = !0);
			if (0 !== u) {
	...
	y.prototype.exportChart = function (a) {
		...
		if (a.toDataURL)
			return this.canvas.toDataURL("image/" + c);
		Aa(this.canvas, c, b)
	};
	...
	V.prototype.render = function (a) {
		...
		for (b = 0; b < this._wrappedText.lines.length; b++)
			g = this._wrappedText.lines[b], "right" === this.horizontalAlign ? d = this.width - g.width - this.padding : "left" === this.horizontalAlign ? d = this.padding : "center" === this.horizontalAlign && (d = (this.width - 2 * this.padding) / 2 - g.width / 2 + this.padding), this.ctx.fillText(g.text, d, f), f += g.height;
		this.ctx.font = c;
		a && this.ctx.restore()
	};
	...
	wa.prototype.render = function () {
		...
		for (p = 0; p < this.items.length; p++)
			e = l[p], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = {
				id : e.id,
		...
		for (p = c = 0; p < m.length; p++) {
			...
			for (w = t = 0; w < n.items.length; w++) {
				...
				if ("line" === e.chartType || "stepLine" === e.chartType || "spline" === e.chartType)
					this.ctx.strokeStyle = e.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(r - 0.1 * this.lineHeight, u + this.lineHeight / 2), this.ctx.lineTo(r + 0.85 * this.lineHeight, u + this.lineHeight / 2), this.ctx.stroke(), q -= 0.1 * this.lineHeight;
	...
	aa.prototype.getDefaultAxisPlacement = function () {
		...
		if ("column" === a || "line" === a || "stepLine" === a || "spline" === a || "area" === a || "stepArea" === a || "splineArea" === a || "stackedColumn" === a || "stackedLine" === a || "bubble" === a || "scatter" === a || "stackedArea" === a || "stackedColumn100" === a || "stackedLine100" ===
			a || "stackedArea100" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeArea" === a || "rangeSplineArea" === a)
			return "normal";
	...
	aa.getDefaultLegendMarker = function (a) {
		if ("column" === a || "stackedColumn" === a || "stackedLine" === a || "bar" === a || "stackedBar" === a || "stackedBar100" === a || "bubble" === a || "scatter" === a ||
			"stackedColumn100" === a || "stackedLine100" === a || "stepArea" === a || "candlestick" === a || "ohlc" === a || "rangeColumn" === a || "rangeBar" === a || "rangeArea" === a || "rangeSplineArea" === a)
			return "square";
	...
	aa.prototype.getDataPointAtXY = function (a, c, b) {
		if (!this.dataPoints || 0 === this.dataPoints.length || a <
			this.chart.plotArea.x1 || a > this.chart.plotArea.x2 || c < this.chart.plotArea.y1 || c > this.chart.plotArea.y2)
			return null;
		b = b || !1;
		var d = [],
		f = 0,
		...
		for (; ; ) {
			...
			if (0 <= g && g < this.dataPoints.length) {
				...
				if (e) {
					...
					case "doughnut":
						...
						break;
					case "candlestick":
						if (a >= e.x1 - e.borderThickness / 2 && a <= e.x2 + e.borderThickness / 2 && c >= e.y2 - e.borderThickness / 2 && c <= e.y3 + e.borderThickness / 2 || Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && c >= e.y1 && c <= e.y4)
							d.push({
								dataPoint : q,
								dataPointIndex : g,
								dataSeries : this,
					...
					case "ohlc":
						if (Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && c >= e.y2 && c <= e.y3 || a >= e.x1 && a <= (e.x2 +
								e.x1) / 2 && c >= e.y1 - e.borderThickness / 2 && c <= e.y1 + e.borderThickness / 2 || a >= (e.x1 + e.x2) / 2 && a <= e.x2 && c >= e.y4 - e.borderThickness / 2 && c <= e.y4 + e.borderThickness / 2)
							d.push({
								dataPoint : q,
								dataPointIndex : g,
								dataSeries : this,
			...
			} else if (0 > n - f && n + f >= this.dataPoints.length)
				break;
			-1 === h ? (f++, h = 1) : h = -1
		}
		a = null;
	...
	function (a, c, b, d) {
		...
		return {
			...
			borderThickness : f[a].markerBorderThickness ? f[a].markerBorderThickness :
	...
	A.prototype.createExtraLabelsForLog = function (a) {
		...
		if (!(5 < a)) {
			...
			if (Math.log(this.range) / Math.log(c / this.viewportMinimum) < this.noTicks - 1) {
				for (var b = A.getNiceNumber((c - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), d = Math.ceil(this.viewportMinimum / b) * b; d < c; d += b)
	...
	A.prototype.createLabels = function () {
		...
		if ("axisX" !== this.type || "dateTime" !== this.chart.plotInfo.axisXValueType || this.logarithmic) {
			...
			if (this.logarithmic && !this.equidistantInterval) {
				...
				for (var e = 0; e < this.logLabelValues.length; e++)
					b = this.logLabelValues[e], b < this.viewportMinimum || (a = this.labelFormatter ? this.labelFormatter({
								chart : this.chart,
								axis : this.options,
								value : b,
			...
			for (b = this.intervalStartPosition; b <= f; b = parseFloat((this.logarithmic && this.equidistantInterval ? b * Math.pow(this.logarithmBase, this.interval) : b + this.interval).toFixed(14)))
			...
			for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), f = Ga(new Date(this.viewportMaximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < f; Ga(b, k, this.intervalType))
		...
		if (this.labelAutoFit || this.options.labelAutoFit)
			if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
				if (g = 0.9 * l >> 0, n = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
					...
					for (b = 0; b < this._labels.length; b++) {
						...
						for (var r, s = a.text.split(" "), d = 0; d < s.length; d++)
							e = s[d], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, e = this.ctx.measureText(e), e.width > n && (r = b, n = e.width)
					}
					b = 0;
					for (b = this.intervalStartPosition < this.viewportMinimum ? 1 :
						...
						if (a = this._labels[b].textBlock, q = a.measureText(), b < this._labels.length - 1 && (e = b + 1, c = this._labels[e].textBlock, c = c.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math, f), Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d = g * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (h - a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), x(this.options.labelAngle) && isNaN(this.options.labelAngle) &&
							...
							if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? h : Math.min((d - g * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), d), s = (p - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !x(this.options.labelWrap))
								this.labelWrap ? x(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(g, n), s), this.sessionVariables.labelWrap = this.labelWrap, q.width + c.width >> 0 > 2 *
								...
								if (x(this.options.labelWrap))
									if (!x(this.options.labelMaxWidth))
										this.options.labelMaxWidth < g ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = d) : (this.sessionVariables.labelAngle = -25,
											this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = h);
									else if (!x(c))
										if (d = q.width + c.width >> 0, e = this.labelFontSize, n < g)
											d - 2 * g > k && (k = d - 2 * g, d >= 2 * g && d < 2.2 * g ? (this.sessionVariables.labelMaxWidth = g, x(this.options.labelFontSize) && 12 < e && (e = Math.floor(12 / 13 * e), a.measureText()), this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : d >= 2.2 * g && d < 2.8 * g ? (this.sessionVariables.labelAngle =
										...
										else if (r === b && (0 === r && n + this._labels[r + 1].textBlock.measureText().width - 2 * g > k || r === this._labels.length - 1 && n + this._labels[r - 1].textBlock.measureText().width - 2 * g > k || 0 < r && r < this._labels.length - 1 && n + this._labels[r + 1].textBlock.measureText().width - 2 * g > k && n + this._labels[r - 1].textBlock.measureText().width - 2 * g > k))
											k = 0 === r ? n + this._labels[r + 1].textBlock.measureText().width - 2 * g : n +
											...
											for (this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, d = 0; d < this._labels.length; d++)
												a = this._labels[d].textBlock, a.maxWidth = this.sessionVariables.labelMaxWidth =
				...
				if (g = x(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, h = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
					...
					for (d = 0; d < this._labels.length; d++)
						a = this._labels[d].textBlock, a.maxWidth = this.labelMaxWidth = this.sessionVariables.labelMaxWidth, a.fontSize = this.labelFontSize = this.sessionVariables.labelFontSize, a.angle = this.labelAngle =
		...
		for (b = 0; b < this.stripLines.length; b++) {
			...
			if ("outside" === g.labelPlacement) {
				...
				if ("bottom" === this._position || "top" === this._position)
					u = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 *
						this.chart.height >> 0 : 1.5 * this.labelFontSize;
				if ("left" === this._position || "right" === this._position)
					u = "undefined" === typeof g.options.labelWrap ? this.sessionVariables.labelMaxHeight : g.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
				c = x(g.options.labelBackgroundColor) ? "#EEEEEE" : g.options.labelBackgroundColor
			} else
				h = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0, u = "undefined" === typeof g.options.labelWrap || g.labelWrap ? "bottom" === this._position ||
	...
	A.setLayoutAndRender = function (a, c, b, d, f, g) {
		...
		if (a && 0 < a.length)
			for (e = 0; e < a.length; e++)
				a[e] && a[e].title && (a[e]._titleTextBlock = new V(a[e].ctx, {
							text : a[e].title,
							horizontalAlign : "center",
		...
		if (c && 0 < c.length)
			for (e = 0; e < c.length; e++)
				c[e] && c[e].title && (c[e]._titleTextBlock = new V(c[e].ctx, {
							text : c[e].title,
							horizontalAlign : "center",
		...
		if (b && 0 < b.length)
			for (e = 0; e < b.length; e++)
				b[e] && b[e].title && (b[e]._titleTextBlock = new V(b[e].ctx, {
							text : b[e].title,
							horizontalAlign : "center",
		...
		if (d && 0 < d.length)
			for (e = 0; e < d.length; e++)
				d[e] && d[e].title && (d[e]._titleTextBlock =
						new V(d[e].ctx, {
							text : d[e].title,
							horizontalAlign : "center",
		...
		if ("normal" === f) {
			...
			if (a && 0 < a.length)
				for (e = 0; e < a.length; e++)
					a[e] && a[e].title && (a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width, a[e]._titleTextBlock.maxHeight = a[e].titleWrap ? 0.8 * g.height : 1.5 * a[e].titleFontSize, a[e]._titleTextBlock.angle =
							0);
			if (c && 0 < c.length)
				for (e = 0; e < c[e].length; e++)
			...
			for (; 4 > q; ) {
				...
				S = 0;
				if (b && 0 < b.length)
					for (t = [], e = T = 0; e < b.length; e++)
						t.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), T += t[e], C += b[e] ? b[e].margin : 0;
				else
					t.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
				K.push(t);
				if (d && 0 < d.length)
					for (w = [], e = S = 0; e < d.length; e++)
						w.push(Math.ceil(d[e] ?
				...
				if (a && 0 < a.length)
					for (u = [], e = W = 0; e < a.length; e++)
						a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(l - h), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width),
						u.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)), W += u[e], f += a[e] ? a[e].margin : 0;
				else
					u.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
				G.push(u);
				if (c && 0 < c.length)
					for (v = [], e = U = 0; e < c.length; e++)
						c[e] && (c[e].lineCoordinates = {}), c[e].lineCoordinates.width = Math.abs(l - h), c[e].title && (c[e]._titleTextBlock.maxWidth = 0 < c[e].titleMaxWidth && c[e].titleMaxWidth < c[e].lineCoordinates.width ? c[e].titleMaxWidth : c[e].lineCoordinates.width), v.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() :
								0)), U += v[e], X += c[e] ? c[e].margin : 0;
				else
					v.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
				I.push(v);
				if (a && 0 < a.length)
					for (e = 0; e < a.length; e++)
						a[e] && (a[e].lineCoordinates.x1 = h, a[e].lineCoordinates.x2 = Math.round(g.x2 - S - Q > p.width - 10 ? p.width - 10 : g.x2 - S - Q), a[e]._labels && 1 < a[e]._labels.length && (k = m = 0, m = a[e]._labels[1], k = "dateTime" === a[e].chart.plotInfo.axisXValueType ? a[e]._labels[a[e]._labels.length - 2] : a[e]._labels[a[e]._labels.length - 1], r = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) +
				...
				if (c && 0 < c.length)
					for (e = 0; e < c.length; e++)
						c[e].lineCoordinates.x1 = Math.round(g.x1 + T + C), c[e].lineCoordinates.x2 = Math.round(g.x2 - S - Q > p.width - 10 ? p.width - 10 : g.x2 - S - Q), c[e].lineCoordinates.width = Math.abs(l - h), c[e]._labels && 1 < c[e]._labels.length && (m = c[e]._labels[1], k = "dateTime" === c[e].chart.plotInfo.axisXValueType ?
				...
				if (b && 0 < b.length)
					for (e = 0; e < b.length; e++)
						C = 10, b[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), C = b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2, k = Math.round(g.y1 + U + X < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + U + X), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : c[0].lineCoordinates.x1), C = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height /
				...
				if (d && 0 < d.length)
					for (e = 0; e < d.length; e++)
						d[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : c[0].lineCoordinates.x2), l = Math.round(h), C = d[e]._labels[d[e]._labels.length -
			...
			if (a && 0 < a.length)
				for (e = 0; e < a.length; e++)
					a[e] && a[e].title && (a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width, a[e]._titleTextBlock.maxHeight =
							a[e].titleWrap ? 0.8 * g.height : 1.5 * a[e].titleFontSize, a[e]._titleTextBlock.angle = -90);
			if (c && 0 < c.length)
				for (e = 0; e < c.length; e++)
					c[e] && c[e].title && (c[e]._titleTextBlock.maxWidth = c[e].titleMaxWidth || g.width, c[e]._titleTextBlock.maxHeight = c[e].titleWrap ? 0.8 * g.height : 1.5 * c[e].titleFontSize, c[e]._titleTextBlock.angle = 90);
			if (b && 0 < b.length)
				for (e = 0; e < b.length; e++)
					b[e] && b[e].title && (b[e]._titleTextBlock.maxWidth = b[e].titleMaxWidth || g.width, b[e]._titleTextBlock.maxHeight = b[e].titleWrap ? 0.8 * g.height : 1.5 * b[e].titleFontSize,
						b[e]._titleTextBlock.angle = 0);
			if (d && 0 < d.length)
				for (e = 0; e < d.length; e++)
					d[e] && d[e].title && (d[e]._titleTextBlock.maxWidth = d[e].titleMaxWidth || g.width, d[e]._titleTextBlock.maxHeight = d[e].titleWrap ? 0.8 * g.height : 1.5 * d[e].titleFontSize, d[e]._titleTextBlock.angle = 0);
			for (; 4 > q; ) {
				U = W = T = O = Q = C = X = f = M = J = P = L = 0;
				if (a && 0 < a.length)
					for (B = [], e = W = 0; e < a.length; e++)
						B.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateWidth() : 0)), W += B[e], f += a[e] ? a[e].margin : 0;
				else
					B.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
				I.push(B);
				if (c && 0 < c.length)
					for (r = [], e = U = 0; e < c.length; e++)
						r.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateWidth() : 0)), U += r[e], X += c[e] ? c[e].margin : 0;
				else
					r.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
				K.push(r);
				if (b && 0 < b.length)
					for (e = 0; e < b.length; e++)
						b[e].lineCoordinates = {},
				h = Math.round(g.x1 + W + f),
				l = Math.round(g.x2 - U - X > p.width - 10 ? p.width - 10 : g.x2 - U - X),
				b[e].labelAutoFit && !x(u) && (0 < !a.length && (h = 0 > b[e].labelAngle ? Math.max(h, u) : 0 === b[e].labelAngle ? Math.max(h, u / 2) : h), 0 < !c.length && (l = 0 <
							b[e].labelAngle ? l - v / 2 : 0 === b[e].labelAngle ? l - v / 2 : l)),
				b[e].lineCoordinates.x1 = h,
				b[e].lineCoordinates.x2 = l,
				b[e].lineCoordinates.width = Math.abs(l - h),
				b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.width ? b[e].titleMaxWidth : b[e].lineCoordinates.width);
				if (d && 0 < d.length)
					for (e = 0; e < d.length; e++)
						d[e].lineCoordinates = {},
				h = Math.round(g.x1 + W + f),
				l = Math.round(g.x2 - U - X > d[e].chart.width - 10 ? d[e].chart.width - 10 : g.x2 - U - X),
				d[e] && d[e].labelAutoFit && !x(t) && (0 < !a.length &&
					(h = 0 < d[e].labelAngle ? Math.max(h, t) : 0 === d[e].labelAngle ? Math.max(h, t / 2) : h), 0 < !c.length && (l -= w / 2)),
				d[e].lineCoordinates.x1 = h,
				d[e].lineCoordinates.x2 = l,
				d[e].lineCoordinates.width = Math.abs(l - h),
				d[e].title && (d[e]._titleTextBlock.maxWidth = 0 < d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.width ? d[e].titleMaxWidth : d[e].lineCoordinates.width);
				if (b && 0 < b.length)
					for (y = [], e = O = 0; e < b.length; e++)
						y.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateHeight() : 0)), O += y[e] + b[e].margin, C += b[e].margin;
				else
					y.push(Math.ceil(b[0] ?
							b[0].createLabelsAndCalculateHeight() : 0));
				s.push(y);
				if (d && 0 < d.length)
					for (A = [], e = T = 0; e < d.length; e++)
						A.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateHeight() : 0)), T += A[e], Q += d[e].margin;
				else
					A.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
				G.push(A);
				if (b && 0 < b.length)
					for (e = 0; e < b.length; e++)
						0 < b[e]._labels.length && (m = b[e]._labels[0], k = b[e]._labels[b[e]._labels.length - 1], u = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI /
				...
				if (d && 0 < d.length)
					for (e = 0; e < d.length; e++)
						d[e] && 0 < d[e]._labels.length && (m = d[e]._labels[0], k = d[e]._labels[d[e]._labels.length - 1], t = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - k.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)), w = k.textBlock.width *
				...
				if (p.panEnabled)
					for (e = 0; e < b.length; e++)
						y[e] = p.sessionVariables.axisY.height;
				else
					for (e = 0; e < b.length; e++)
						p.sessionVariables.axisY.height = y[e];
				if (b && 0 < b.length)
					for (e = b.length - 1; 0 <= e; e--)
						k = Math.round(g.y2), m = Math.round(g.y2 > b[e].chart.height - 10 ? b[e].chart.height - 10 : g.y2), b[e].lineCoordinates.y1 = k - (y[e] + b[e].margin + L), b[e].lineCoordinates.y2 = k - (y[e] + b[e].margin +
								L), b[e].bounds = {
							x1 : h,
				...
				if (d && 0 < d.length)
					for (e = d.length - 1; 0 <= e; e--)
						d[e] && (k = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + d[e].margin + P)), d[e].lineCoordinates.y1 = m, d[e].lineCoordinates.y2 = m, d[e].bounds = {
								x1 : h,
								y1 : k + (d[e].margin + P),
								x2 : l,
								y2 : m,
					...
					for (e = 0; e < a.length; e++) {
						...
						if (b && 0 < b.length)
							for (C = 0; C < b.length; C++)
								b[C] && b[C].labelAutoFit && (l = 0 > b[C].labelAngle ? Math.max(l, u) : 0 === b[C].labelAngle ? Math.max(l, u / 2) : l, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? l - W : h);
						if (d && 0 < d.length)
							for (C = 0; C < d.length; C++)
								d[C] && d[C].labelAutoFit && (l = d[C].lineCoordinates.x1, h = l - W);
						a[e].lineCoordinates = {
							x1 : l - J,
							y1 : k,
							x2 : l - J,
				...
				if (c && 0 < c.length)
					for (e = 0; e < c.length; e++) {
						...
						if (b && 0 < b.length)
							for (C = 0; C < b.length; C++)
								b[C] && b[C].labelAutoFit && (l = 0 > b[e].labelAngle ? Math.max(l, u) : 0 === b[e].labelAngle ? Math.max(l, u / 2) : l, h = 0 > b[C].labelAngle || 0 === b[C].labelAngle ? l - U : h);
						if (d && 0 < d.length)
							for (C = 0; C < d.length; C++)
								d[C] && d[C].labelAutoFit &&
	...
	A.prototype.renderLabelsTicksAndTitle = function () {
		...
		if ("undefined" === typeof this.options.interval) {
			if ("bottom" === this._position || "top" === this._position)
				if (this.logarithmic &&
					...
					for (l = 0; l < this._labels.length; l++)
						p = this._labels[l], p.position < this.viewportMinimum || (p = p.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + p.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += p);
			...
			if ("left" === this._position || "right" === this._position)
				if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
					...
					for (l = 0; l < this._labels.length; l++)
						p = this._labels[l], p.position < this.viewportMinimum || (p = p.textBlock.height * Math.abs(Math.cos(Math.PI /
		...
		if ("bottom" === this._position) {
			for (var p, l = 0; l < this._labels.length; l++)
				p = this._labels[l], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(p.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness, this.ctx.strokeStyle = this.tickColor, d = 1 === this.ctx.lineWidth %
			...
			for (l = 0; l < this._labels.length; l++)
				p = this._labels[l], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(p.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness &&
			...
			for (l = 0; l < this._labels.length; l++)
				p = this._labels[l], p.position < this.viewportMinimum || p.position > this.viewportMaximum || (b = this.getPixelCoordinatesOnAxis(p.position), a && 0 !== f++ % 2 && this.labelAutoFit || (this.tickThickness && (this.ctx.lineWidth = this.tickThickness,
	...
	A.prototype.renderInterlacedColors = function () {
		...
		if (("bottom" === this._position || "top" === this._position) &&
			...
			for (a.fillStyle = this.interlacedColor, f = 0; f < this._labels.length; f++)
				c ? (c = this.getPixelCoordinatesOnAxis(this._labels[f].position), b = f + 1 > this._labels.length - 1 ? this.getPixelCoordinatesOnAxis(this.viewportMaximum) : this.getPixelCoordinatesOnAxis(this._labels[f + 1].position), a.fillRect(Math.min(b.x, c.x), d.y1, Math.abs(b.x - c.x), Math.abs(d.y1 - d.y2)), c = !1) : c = !0;
		...
		if (this.stripLines && 0 < this.stripLines.length && a) {
				...
				if (m = this.stripLines[d], b = this._stripLineLabels[d], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
					...
					if ("outside" === b.stripLine.labelPlacement)
						if (m && (this.ctx.strokeStyle = m.color, "pixel" === m._thicknessType && (this.ctx.lineWidth = m.thickness)), "bottom" ===
							...
							"top" === this._position ? (p = 1 === this.ctx.lineWidth %
						...
						b.textBlock.angle = -90, "bottom" === this._position ? (b.textBlock.maxWidth = this.options.stripLines[d].labelMaxWidth ? this.options.stripLines[d].labelMaxWidth : this.chart.plotArea.height - 3, b.textBlock.measureText(), a.x - b.textBlock.height > this.chart.plotArea.x1 ? x(m.startValue) ? a.x -= b.textBlock.height - b.textBlock.fontSize / 2 : a.x -= b.textBlock.height / 2 - b.textBlock.fontSize / 2 + 3 : (b.textBlock.angle =
			...
			if (!h) {
				...
				for (d = 0; d < k.length; d++)
					m = k[d], m.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
							this.ctx.save();
							this.ctx.beginPath();
							this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
							this.ctx.clip();
							for (f = 0; f < k.length; f++)
								m = k[f], m.showOnTop && m.render();
							this.ctx.restore()
						}, m)) : m.render();
				for (d = 0; d < l.length; d++)
					b = l[d], b.stripLine.showOnTop ?
					h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
							for (f = 0; f < l.length; f++)
								b = l[f], "inside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && (c.ctx.save(), c.ctx.beginPath(), c.ctx.rect(c.chart.plotArea.x1, c.chart.plotArea.y1, c.chart.plotArea.width, c.chart.plotArea.height), c.ctx.clip(), b.textBlock.render(!0), c.ctx.restore())
						}, b.textBlock)) : "inside" === b.stripLine.labelPlacement && b.textBlock.render(!0);
				this.ctx.restore();
				h = !0
			}
			if (h)
				for (h = !1, d = 0; d < l.length; d++)
					b = l[d], b.stripLine.showOnTop ?
					h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
							for (f = 0; f < l.length; f++)
								b = l[f], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0)
		...
		if (this.gridThickness && 0 < this.gridThickness) {
			...
			if ("bottom" === this._position || "top" === this._position)
				...
				for (var d = 0; d < this._labels.length; d++)
					this._labels[d].position < this.viewportMinimum ||
	...
	A.prototype.renderAxisLine = function () {
		...
		if ("bottom" === this._position || "top" === this._position) {
			...
			"left" !== this._position && "right" !== this._position || !this.lineThickness || (a.lineWidth = this.lineThickness, a.strokeStyle = this.lineColor, a.setLineDash && a.setLineDash(E(this.lineDashType, this.lineThickness)), c = 1 === this.lineThickness % 2 ? (this.lineCoordinates.x1 << 0) + 0.5 : this.lineCoordinates.x1 <<
	...
	A.prototype.getPixelCoordinatesOnAxis = function (a) {
		var c = {};
		if ("bottom" === this._position || "top" === this._position)
			c.x = this.convertValueToPixel(a), c.y = this.lineCoordinates.y1;
		if ("left" === this._position || "right" === this._position)
			c.y = this.convertValueToPixel(a), c.x = this.lineCoordinates.x2;
		return c
	};
	...
	A.prototype.calculateValueToPixelConversionParameters = function (a) {
		...
		if ("bottom" === this._position || "top" === this._position)
			this.logarithmic ? (a.lnLogarithmBase = Math.log(this.logarithmBase), a.pixelPerUnit = (this.reversed ? -1 : 1) * c * a.lnLogarithmBase / Math.log(Math.abs(this.range))) : a.pixelPerUnit =
		...
		if (this.logarithmic)
			...
			if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType) {
				...
				if (null === this.viewportMinimum ||
					...
					this.viewportMinimum = "axisX" === this.type ? d - g / 2 : Math.floor(d / this.interval) * this.interval;
				if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
					this.viewportMaximum = "axisX" === this.type ? f + g / 2 : Math.ceil(f / this.interval) * this.interval;
			...
			if (null === this.minimum || null === this.maximum)
				if ("axisX" === this.type ? (d = null !== this.minimum ? this.minimum : this.dataInfo.min, f = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === f - d && (b = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, f += b, d -= b), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - d ? 0.5 * Math.abs(f - d) : 1) : "axisY" === this.type && (d = null !== this.minimum ? this.minimum : this.dataInfo.min, f = null !==
					...
					this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? d - g / 2 : Math.floor(d / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum ||
	...
	A.prototype.calculateLogarithamicAxisParameters = function () {
		...
		if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
			this.viewportMinimum = "axisX" === this.type ? d / Math.sqrt(g) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(d) / c / this.interval));
		if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
		...
		if (!this.options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) {
			...
			this.options.interval || (b = Math.ceil(this.interval), this.range > this.interval && (this.interval = b, d = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (c * this.interval) + 0.2) * this.interval))),
	...
	A.prototype.getLabelStartPoint = function () {
		...
		if ("millisecond" !== this.intervalType)
			if ("second" === this.intervalType)
				...
				if (0 <
					a.getDay() || 0 < a.getHours() || 0 < a.getMinutes() || 0 < a.getSeconds() || 0 < a.getMilliseconds())
				...
				"year" === this.intervalType && (0 < a.getMonth() || 1 < a.getDate() || 0 < a.getHours() ||
	...
	na.prototype.render = function () {
		...
		if (0 < c) {
			...
			if ("bottom" === this.parent._position || "top" === this.parent._position)
				f = g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = {
					x1 : f - c / 2,
					y1 : h,
					x2 : g + c / 2,
					y2 : k
				...
				h = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, f = this.chart.plotArea.x1, g = this.chart.plotArea.x2, this.bounds = {
					x1 : f,
					y1 : h - c / 2,
					x2 : g,
					y2 : k + c / 2
		...
		if (!this.chart.disableToolTip) {
			...
			if (this.shared &&
				...
				if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
					...
					if (this.chart.axisX)
						for (var k = 0; k < this.chart.axisX.length; k++) {
							for (var h = this.chart.axisX[k].convertPixelToValue({
										y : c
									}), l = null, d = 0; d < this.chart.axisX[k].dataSeries.length; d++)
								(l = this.chart.axisX[k].dataSeries[d].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[k].dataSeries[d], null !== l.dataPoint.y && f.push(l));
							l = null
						}
					if (this.chart.axisX2)
						for (k = 0; k < this.chart.axisX2.length; k++) {
							...
							l = null;
							for (d = 0; d < this.chart.axisX2[k].dataSeries.length; d++)
								(l = this.chart.axisX2[k].dataSeries[d].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[k].dataSeries[d], null !== l.dataPoint.y && f.push(l));
							l = null
						}
				} else {
					f = [];
					if (this.chart.axisX)
						for (k = 0; k < this.chart.axisX.length; k++)
							for (h = this.chart.axisX[k].convertPixelToValue({
								...
								(l = this.chart.axisX[k].dataSeries[d].getDataPointAtX(h,
					...
					if (this.chart.axisX2)
						for (k = 0; k < this.chart.axisX2.length; k++)
							for (h = this.chart.axisX2[k].convertPixelToValue({
										x : a
									}), l = null, d = 0; d < this.chart.axisX2[k].dataSeries.length; d++)
								(l = this.chart.axisX2[k].dataSeries[d].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[k].dataSeries[d], null !== l.dataPoint.y && f.push(l))
				}
				if (0 === f.length)
					return;
				...
				for (d = 0; d < f.length; d++)
					f[d].dataPoint.x.valueOf() === b.dataPoint.x.valueOf() && g.push(f[d]);
				f = null
			} else {
				if (l = this.chart.getDataPointAtXY(a, c, b))
				...
				if (0 <= this.currentSeriesIndex) {
					...
					if (0 <= this.currentDataPointIndex)
						d = f.dataPoints[this.currentDataPointIndex], l.dataSeries = f, l.dataPoint = d, l.index = this.currentDataPointIndex, l.distance = Math.abs(d.x - h);
					else {
						if (!this.enabled || "line" !== f.type && "stepLine" !== f.type && "spline" !== f.type && "area" !== f.type && "stepArea" !== f.type && "splineArea" !== f.type && "stackedArea" !==
							f.type && "stackedArea100" !== f.type && "rangeArea" !== f.type && "rangeSplineArea" !== f.type && "candlestick" !== f.type && "ohlc" !== f.type)
							return;
					...
					if (!x(l.dataPoint.y))
						if (l.dataSeries.axisY)
							if (0 < l.dataPoint.y.length) {
								for (d = b = 0; d < l.dataPoint.y.length; d++)
									l.dataPoint.y[d] < l.dataSeries.axisY.viewportMinimum ? b-- : l.dataPoint.y[d] > l.dataSeries.axisY.viewportMaximum && b++;
								b < l.dataPoint.y.length &&
								b > -l.dataPoint.y.length && g.push(l)
							} else
								"column" === f.type || "bar" === f.type ? 0 > l.dataPoint.y ? 0 > l.dataSeries.axisY.viewportMinimum && l.dataSeries.axisY.viewportMaximum >= l.dataPoint.y && g.push(l) : l.dataSeries.axisY.viewportMinimum <= l.dataPoint.y && 0 <= l.dataSeries.axisY.viewportMaximum && g.push(l) : "bubble" === f.type ? (b = this.chart._eventManager.objectMap[f.dataPointIds[l.index]].size / 2, l.dataPoint.y >= l.dataSeries.axisY.viewportMinimum - b && l.dataPoint.y <= l.dataSeries.axisY.viewportMaximum + b && g.push(l)) : (0 <= l.dataSeries.type.indexOf("100") ||
				...
				if (b = "", b = this.getToolTipInnerHTML({
					...
					try {
						this.contentDiv.style.background = this.backgroundColor ? this.backgroundColor :
							u ? "rgba(255,255,255,.9)" : "rgb(255,255,255)",
						this.contentDiv.style.borderRightColor = this.contentDiv.style.borderLeftColor = this.contentDiv.style.borderColor = this.borderColor ? this.borderColor : g[0].dataPoint.color ? g[0].dataPoint.color : g[0].dataSeries.color ? g[0].dataSeries.color : g[0].dataSeries._colorSet[g[0].index % g[0].dataSeries._colorSet.length],
						this.contentDiv.style.borderWidth = this.borderThickness || 0 === this.borderThickness ? this.borderThickness + "px" : "2px",
						this.contentDiv.style.borderRadius = this.cornerRadius ||
							0 === this.cornerRadius ? this.cornerRadius + "px" : "5px",
						this.container.style.borderRadius = this.contentDiv.style.borderRadius,
						...
						this.contentDiv.style.fontStyle = this.fontStyle ? this.fontStyle :
							u ? "italic" : "normal"
					} catch (m) {}
		...
		c = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
			...
			for (var l = null, m = "", k = 0; k < a.length; k++)
				if (b = a[k].dataSeries, d = a[k].dataPoint, f =
					...
					if ("line" === b.type ||
						"stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" === b.type || "bar" === b.type || "scatter" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "stackedArea" === b.type || "stackedArea100" === b.type)
						this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent :
						...
						this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") +
						"\"'>{name}:</span>&nbsp;&nbsp;{y}, &nbsp;&nbsp;{z}";
					else if ("rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type)
						this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span>&nbsp;&nbsp;{y[0]},&nbsp;{y[1]}";
					else if ("candlestick" === b.type || "ohlc" === b.type)
						this.chart.axisX && 1 < this.chart.axisX.length && (g += l != b.axisXIndex ? b.axisX.title ? b.axisX.title + "<br/>" : "X:{axisXIndex}<br/>" : ""), g += d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>{name}:</span><br/>Open: &nbsp;&nbsp;{y[0]}<br/>High: &nbsp;&nbsp;&nbsp;{y[1]}<br/>Low:&nbsp;&nbsp;&nbsp;{y[2]}<br/>Close: &nbsp;&nbsp;{y[3]}";
					null === c && (c = "");
			...
			d = a[0].dataPoint;
			f = a[0].index;
			if (null === d.toolTipContent || "undefined" === typeof d.toolTipContent && null === b.options.toolTipContent)
				return null;
			if ("line" === b.type || "stepLine" === b.type || "spline" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "column" ===
				...
				g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + ":</span>&nbsp;&nbsp;{y}";
			else if ("bubble" === b.type)
				g = d.toolTipContent ? d.toolTipContent :
				...
				g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.name ? "{name}:</span>&nbsp;&nbsp;" :
						d.label ? "{label}:</span>&nbsp;&nbsp;" : "</span>") + "{y}";
			else if ("rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type)
				g = d.toolTipContent ? d.toolTipContent : b.toolTipContent ? b.toolTipContent : this.content && "function" !== typeof this.content ? this.content : "<span style='\"" + (this.fontColor ? "" : "'color:{color};'") + "\"'>" + (d.label ? "{label}" : "{x}") + " :</span>&nbsp;&nbsp;{y[0]}, &nbsp;{y[1]}";
			else if ("candlestick" === b.type || "ohlc" === b.type)
				g = d.toolTipContent ? d.toolTipContent :
	...
	y.prototype.getPercentAndTotal = function (a, c) {
		...
		if (0 <= a.type.indexOf("stacked"))
			d = 0, b = c.x.getTime ? c.x.getTime() : c.x, b in a.plotUnit.yTotals && (d = a.plotUnit.yTotals[b], f = isNaN(c.y) ? 0 : 0 === d ? 0 : 100 * (c.y / d));
		else if ("pie" ===
			...
			if ("x" === a)
				if ("dateTime" === g.plotInfo.axisXValueType || "dateTime" === b.xValueType || c.x && c.x.getTime) {
					if (g.plotInfo.plotTypes[0].plotUnits[0].axisX &&
						...
						return Da(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : g.axisX && g.axisX.autoValueFormatString ? g.axisX.autoValueFormatString : "DD MMM YY", g._cultureInfo)
				} else
					return da(h, c.xValueFormatString ? c.xValueFormatString : b.xValueFormatString ? b.xValueFormatString : "#,##0.########", g._cultureInfo);
			else
				return "y" === a ? da(h, c.yValueFormatString ? c.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : "#,##0.########",
		...
		if ("mousemove" === a.type || "click" === a.type) {
			...
			if ((d = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[d])
				if (d = this.objectMap[d], "dataPoint" === d.objectType) {
					...
					"legendItem" === d.objectType && (f = this.chart.data[d.dataSeriesIndex], g = null !== d.dataPointIndex ? f.dataPoints[d.dataPointIndex] : null, d.eventParameter = {
							x : b.x,
							y : b.y,
							dataSeries : f.options,
							dataPoint : g,
	...
	Ca.prototype.animate = function (a, c, b, d, f) {
		...
		for (a = []; 0 < this.animations.length; )
			if (c = this.animations.shift(), b = (new Date).getTime(), d = 0, c.startTime <= b && (d = f(Math.min(b - c.startTime, c.duration), 0, 1, c.duration), d = Math.min(d, 1), isNaN(d) || !isFinite(d)) && (d = 1), 1 > d && a.push(c), c.animationCallback(d), 1 <= d && c.onComplete)
				c.onComplete();
		this.animations = a;
	...
	Oa = {
		...
		formatNumber : function (a, c, b) {
			b = b || "en";
			if (pa[b])
				return da(a, c || "#,##0.##", new oa(b));
			throw "Unknown Culture Name";
		},
		formatDate : function (a, c, b) {
			b = b || "en";
			if (pa[b])
				return Da(a, c || "DD MMM YYYY",
					new oa(b));
			throw "Unknown Culture Name";
		}
	};
